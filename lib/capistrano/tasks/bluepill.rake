namespace :bluepill do
  ...
  task :start do
    on roles(:app) do
      execute :sudo, "bluepill goliath start"
    end
  end
  ...
  task :restart do
    on roles(:app) do
      execute :sudo, "bluepill goliath restart"
    end
  end
  ...
  task :stop do
    on roles(:app) do
      execute :sudo, "bluepill goliath stop"
    end
  end
  ...
  task :quit do
    on roles(:app) do
      execute :sudo, "bluepill goliath quit"
    end
  end
  ...
  task :status do
    on roles(:app) do
      execute :sudo, "bluepill goliath status"
    end
  end
end
